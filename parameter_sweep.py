"""Unified parameter sweep and global scan utilities.

This module consolidates the public sweep/scan API so callers can import from a
single place. Implementations are currently delegated to the existing
functions in `Model_Setup_Density.py` to preserve behavior while we
incrementally deduplicate and refactor.

Public API:
    - setup_parameter_sweep
    - run_parameter_sweep
    - plot_parameter_sweep
    - extract_parameter_trends
...
# -------------------------------
# Parameter sweep (setup/run/plots)
# -------------------------------
